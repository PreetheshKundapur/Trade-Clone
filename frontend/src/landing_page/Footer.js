...
function Footer() {
    return ( 
      ...
      <div className='row mt-5'>
        <div className='col'>
            <img src='Media/Trade.jpg' style={{width:"50%"}}/> 
            <p> &copy; From 2010 - 2024 Broking Limited are Reversed</p>
            </div>
         <div className='col'> 
            <p>Company</p>
            ...
            <br/>
            <a href=''style={{textDecoration:"none"}}>Trade-Easy.Tech</a>
            <br/>
            <a href=''style={{textDecoration:"none"}}>Press And Media</a>
            <br/>
            <a href=''style={{textDecoration:"none"}}>Trade-Easy cares (CRS)</a>
            <br/>
         </div>
          <div className='col'> 
            <p>
            Support </p>
                ...
                <a href=''style={{textDecoration:"none"}}>Support</a>
                 <br/>
                <a href=''style={{textDecoration:"none"}}>Trade-Easy-Connect blog</a>
                 <br/>
                <a href=''style={{textDecoration:"none"}}>List of Charges</a>
                 <br/>
                <a href=''style={{textDecoration:"none"}}>Downloads and Resourses</a>
                 <br/>
          </div>
           <div className='col'> 
            <p>
